      ...
      >
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-8">
            <span
              className={`font-mono transition-colors text-sm ${isExpanded || isHovered ? "text-cyan" : "text-slate-600"}`}
            >
          ...
          <div className="flex items-center gap-4">
            ...
            <motion.div
              ...
              className={`transition-colors ${isExpanded || isHovered ? "text-cyan" : "text-slate-600"}`}
            >
              <Plus size={24} />
            </motion.div>
          </div>
        ...
        {/* Floating Preview on Hover (only when not expanded) */}
        <AnimatePresence>
          {isHovered && !isExpanded && (
            ...
            >
              <div
                className="w-48 h-32 rounded-lg overflow-hidden border-2 relative"
                style={{ borderColor: project.color, boxShadow: `0 0 30px ${project.color}40` }}
              >
                <img
